    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:serialized").unmarshal().avro(AvroLibrary.Jackson3, JsonNode.class).to("mock:pojo");
                from("direct:pojo").marshal().avro(AvroLibrary.Jackson3).to("mock:serialized");
            }
        };
    }
