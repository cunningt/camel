...
/**
 * Data type able to unmarshal Exchange body to Java object. Supports both Avro schema types and uses Jackson Avro
 ...
 */
@DataTypeTransformer(name = "avro-x-java-object-jackson3",
                     description = "Transforms from JSon to Java object using Jackson 3 Avro (supports content schema)")
