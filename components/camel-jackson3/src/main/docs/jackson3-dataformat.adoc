= JSON Jackson3 DataFormat
:doctitle: JSON Jackson3
:shortname: jackson3
:artifactid: camel-jackson3
:description: Marshal POJOs to JSON and back using Jackson 3.
:since: 4.19
...
=== Using Jackson3 with the json() DSL

Jackson3 can also be used via the generic `json()` DSL method by specifying `JsonLibrary.Jackson3`:

[source,java]
-------------------------------
from("activemq:My.Queue")
  .marshal().json(JsonLibrary.Jackson3)
  .to("mqseries:Another.Queue");
-------------------------------
...
// Pretty print
from("activemq:My.Queue")
  .marshal().json(JsonLibrary.Jackson3, true)
  .to("mqseries:Another.Queue");

// Specify unmarshal type
from("activemq:My.Queue")
  .unmarshal().json(JsonLibrary.Jackson3, MyPojo.class)
  .to("mqseries:Another.Queue");
-------------------------------
