    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                ...
                from("direct:inPojoAgeView").marshal().jacksonXml3(TestPojoView.class, Views.Age.class);
                // END SNIPPET: format
                from("direct:backPojoAgeView").unmarshal().jacksonXml3(TestPojoView.class).to("mock:reversePojoAgeView");

                from("direct:inPojoWeightView").marshal().jacksonXml3(TestPojoView.class, Views.Weight.class);
                from("direct:backPojoWeightView").unmarshal().jacksonXml3(TestPojoView.class).to("mock:reversePojoWeightView");
            }
        };
    }
