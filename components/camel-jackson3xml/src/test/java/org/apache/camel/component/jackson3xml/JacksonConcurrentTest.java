    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                from("direct:start").marshal().jacksonXml3().to("log:marshalled").to("direct:marshalled");

                from("direct:marshalled").unmarshal().jacksonXml3(TestPojo.class).to("mock:result");
            }
        };
    }
