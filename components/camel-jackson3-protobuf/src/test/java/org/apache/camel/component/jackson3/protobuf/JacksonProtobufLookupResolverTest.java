    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:serialized").unmarshal().protobuf(ProtobufLibrary.Jackson3, Pojo.class, "schema-resolver-1")
                        .to("mock:pojo");
                from("direct:pojo").marshal().protobuf(ProtobufLibrary.Jackson3, Pojo.class, "schema-resolver-1")
                        .to("mock:serialized");
            }
        };
    }
