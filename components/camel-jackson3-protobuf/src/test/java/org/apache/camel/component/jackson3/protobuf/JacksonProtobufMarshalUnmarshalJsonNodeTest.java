    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            ...
            public void configure() {
                from("direct:serialized").unmarshal().protobuf(ProtobufLibrary.Jackson3, JsonNode.class).to("mock:pojo");
                from("direct:pojo").marshal().protobuf(ProtobufLibrary.Jackson3).to("mock:serialized");
            }
        };
    }
