...
public final class ModelDeserializersResolver implements YamlDeserializerResolver {
    ...
    public ConstructNode resolve(String id) {
        switch(id) {
            ...
            case "jacksonXml3": return new ModelDeserializers.JacksonXML3DataFormatDeserializer();
            case "org.apache.camel.model.dataformat.JacksonXML3DataFormat": return new ModelDeserializers.JacksonXML3DataFormatDeserializer();
