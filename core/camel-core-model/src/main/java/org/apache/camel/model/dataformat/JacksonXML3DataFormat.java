...
/**
 * Unmarshal an XML payloads to POJOs and back using XMLMapper extension of Jackson 3.
 */
@Metadata(firstVersion = "4.18.0", label = "dataformat,transformation,xml", title = "Jackson 3 XML")
@XmlRootElement(name = "jacksonXml3")
@XmlAccessorType(XmlAccessType.FIELD)
public class JacksonXML3DataFormat extends DataFormatDefinition implements ContentTypeHeaderAware {
    ...
    public JacksonXML3DataFormat() {
        super("jacksonXml3");
    }

    protected JacksonXML3DataFormat(JacksonXML3DataFormat source) {
        super(source);
        this.unmarshalType = source.unmarshalType;
        this.jsonView = source.jsonView;
        this.collectionType = source.collectionType;
        this.xmlMapper = source.xmlMapper;
        ...
        this.enableJaxbAnnotationModule = source.enableJaxbAnnotationModule;
    ...
    @Override
    public JacksonXML3DataFormat copyDefinition() {
        return new JacksonXML3DataFormat(this);
    }
